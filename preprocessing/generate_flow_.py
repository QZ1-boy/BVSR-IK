...
def generate_flow(dir_path):
    dist_list = [2] # for FMA-Net w/ T=3  T=5 2
    ...
    for dir_name in dir_path:
        ...
        for dist in dist_list:
            for idx in tqdm(range(len(img_list))):
                ...
                flow1_0_img_name = os.path.join(dir_name.replace('val_sharp_bicubic', 'val_flow_bicubic'), f'{img1_name}_{img0_name}.png')
                flow1_2_img_name = os.path.join(dir_name.replace('val_sharp_bicubic', 'val_flow_bicubic'), f'{img1_name}_{img2_name}.png')
...
if __name__ == '__main__':
    ...
    # generate_flow('/home/zhuqiang/FMA-Net-main/dataset/Vid4_BlurDown_Gaussian/LR_blurdown_x4')