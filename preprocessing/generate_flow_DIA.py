...
def viz_flow(flo, savepath):
    ...
    flow_0_img = Image.fromarray(flow_0)  # flo[:, :, [2,1,0]]  [:, :, [1,2,0]]
...
def check_img_size(x, window_size):
    ...
    x = torch.nn.functional.pad(x, (0, pad_w, 0, pad_h), "circular")
    ...
    for dir_name in dir_path:
        ...
        for dist in dist_list:
            for idx in tqdm(range(len(img_list))):
                ...
                ref1 = read_img(img_list[idx].replace('aligned', 'refined'))
                ...
                flow1_0_img_name = os.path.join(dir_name.replace('aligned', 'flow_raft'), f'{img1_name}.png')
                # print('flow1_0_img_name',flow1_0_img_name)
...
if __name__ == '__main__':
    ...
    generate_flow('/share3/home/zqiang/FMA-Net-main/results/KCA_REDS_Realistic/REDS4_Realistic/aligned')